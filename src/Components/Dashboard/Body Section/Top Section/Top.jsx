...
<button class="button" aria-label="Chat">
    <svg viewBox="0 0 512 512" class="chat-icon" aria-hidden="true">
...
<button class="button" aria-label="Add">
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" class="add-icon" aria-hidden="true">
